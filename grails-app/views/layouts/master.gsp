...
<head>
    ...
    <link rel="apple-touch-icon"
          href="${resource(dir: 'img/apple', file: 'apple-touch-icon.png')}">
    <link rel="apple-touch-icon" sizes="114x114"
          href="${resource(dir: 'img/apple', file: 'apple-touch-icon-114x114-precomposed.png')}">
    <link rel="apple-touch-icon" sizes="72x72"
          href="${resource(dir: 'img/apple', file: 'apple-touch-icon-72x72-precomposed.png')}">
    <link rel="apple-touch-icon" sizes="57x57"
          href="${resource(dir: 'img/apple', file: 'apple-touch-icon-57x57-precomposed.png')}">
    -->
