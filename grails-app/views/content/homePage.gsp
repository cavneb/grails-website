...
<div id="banner">
    <div class="fullStackFramework banner">
        <div class="left">
            ...
            <p><a href="#" class="btn">Download Grails 2.1</a>&nbsp;&nbsp;<a href="learn.html"
                                                                             class="btn primary">Start using Grails!</a>
            </p>
        </div>
        <ul>
            <li>
...
<!--
    <section class="section-2">
        <div class="col1">
            <a href="#">
                <img src="img/homepage/aQuickTaster.png" alt="A Quick Taster, What is grails?" title="A Quick Taster, What is grails?" />
            </a>
            <p>
                <a href="#" class="btn primary">More screencasts</a>
                <a href="#" class="btn">feed publication</a>
            </p>
        </div>
        <div class="col2">
            <div class="colset">
                <div class="plugins">
                    ...
                    <ul class="list-links">
                        <li><a href="#">Delicious Plugin 2.0.1 <small>(12/12/2012)</small></a></li>
                        <li><a href="#">Dümmy plugin - ignore 2.0.1 <small>(12/12/2012)</small></a></li>
                        <li><a href="#">Zendesk API Plugin 2.0.1 <small>(12/12/2012)</small></a></li>
                        <li><a href="#">Grails Runtime Docs 2.0.1 <small>(12/12/2012)</small></a></li>
                    </ul>
                    <p><a href="#" class="btn primary">View all</a></p>
                </div>
                <div class="download">
                    <h3>Grails 2.0.1 <small>(12/02/2012)</small></h3>
                    <p>Download the latest Grails™ 2.0.1 binary release to experience a new level of productivity on the Java™ platform.</p>
                    <p><a href="#" class="btn primary">Download</a></p>
                </div>
            </div>
        </div>
    </section>
